...
namespace NorthwindCustomers.Controllers
{
    ...
    {
        private readonly NorthwindCustomersContext _context;

        public CustomersController(NorthwindCustomersContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string searchString, int page = 1)
        {
            ...
            {
                customers = customers.Where(x => x.CompanyName.Contains(searchString)
        ...
        public async Task<IActionResult> Create([Bind("CustomerID,CompanyName,ContactName,ContactTitle,Address,City,Region,PostalCode,Country,Phone,FAX")] Customer customer)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["Message"] = "Successfully added new customer!";                
